...
<html lang="en">
  <head>
    ...
    <title>Carcare!<?php echo (isset($title) ? ' - '.$title : ''); ?></title>
  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container" style="border: 0; background: #2A3F54;">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view" style="border: 0; background: #2A3F54;">
            <div class="navbar nav_title" style="border: 0; background: #2A3F54;">
              <a href="<?php echo site_url(); ?>" class="site_title">
               <img width="35" height="35" src="<?php echo base_url(); ?>assets/images/logo.jpg"> <span>Carcare!</span></a>
            </div>
